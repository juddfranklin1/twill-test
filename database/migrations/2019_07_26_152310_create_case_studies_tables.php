...
class CreateCaseStudiesTables extends Migration
{
    public function up()
    {
        ...
        Schema::create('case_study_translations', function (Blueprint $table) {
            createDefaultTranslationsTableFields($table, 'case_study');
        ...
        Schema::create('case_study_slugs', function (Blueprint $table) {
            createDefaultSlugsTableFields($table, 'case_study');
        });

        // remove this if you're not going to use revisions, ie. using the HasRevisions trait
        Schema::create('case_study_revisions', function (Blueprint $table) {
            createDefaultRevisionsTableFields($table, 'case_study');
        });
    }

    public function down()
    {
        Schema::dropIfExists('case_study_revisions');
        Schema::dropIfExists('case_study_translations');
        Schema::dropIfExists('case_study_slugs');
